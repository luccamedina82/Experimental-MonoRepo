import { Body, Controller, ForbiddenException, Post, Req, Res, UseGuards, UsePipes } from "@nestjs/common";
...
export class AuthController {
    ...
    async login(
        ...
        const userAgent = request.headers['user-agent'] || 'Dispositivo desconocido';
